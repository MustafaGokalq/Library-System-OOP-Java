...
public class App {
    ...
    public static Vector<Barrow> borrows = new Vector<Barrow>();
    ...
    private static void fillData() {
        try {
            ...
            borrows.add(new Barrow(20, new GregorianCalendar(), members.elementAt(0), books.elementAt(0)));
            borrows.add(new Barrow(20, new GregorianCalendar(), members.elementAt(1), books.elementAt(1)));
            borrows.add(new Barrow(20, new GregorianCalendar(), members.elementAt(2), books.elementAt(2)));
    ...
    static Barrow createNewBorrow() {
        ...
        try {
            ...
            Book book = getBook();
            Barrow b1 = new Barrow(days, date, member, book);
            borrows.add(b1);
            return b1;
        } catch (Exception e) {
